...
public class NewActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        et_new_content.setOnEditChangeListener(new RichTextEditor.SetOnEditChangeListener() {
            @Override
            public void selecotorAge(int count) {
                ...
                for (int i = 0; i < editList.size(); i++) {
                    ...
                    if (editList.get(i).inputStr != null) {
                        buffer.append(editList.get(i).inputStr);
                    }

                }
//                Toast.makeText(NewActivity.this,buffer.toString().length()+"",Toast.LENGTH_SHORT).show();
                Log.d("cccc", "selecotorAge: "+buffer.toString());
                Log.d("cccc", "selecotorAge: "+buffer.toString().length());

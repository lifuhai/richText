...
public class RichTextEditor extends ScrollView {
	...
	public TextWatcher textWatcher=new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before, int count) {
			editChangeListener.selecotorAge(s.length());
		}
	...
	public SetOnEditChangeListener editChangeListener;
	public void setOnEditChangeListener(SetOnEditChangeListener selectorAge) {
		this.editChangeListener = selectorAge;
	}

	public interface SetOnEditChangeListener {
		void selecotorAge(int count);
	}
	/**
	 * 生成图片View
	 */
